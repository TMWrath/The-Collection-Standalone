...
import com.tmwrath.TheCollection.Standalone.R2;
...
import com.tmwrath.TheCollection.Standalone.activities.TheCollectionArtistActivity;
import com.tmwrath.TheCollection.Standalone.activities.TheCollectionCarntActivity;
...
public class AboutAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class ContributorsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ContributorsViewHolder(View itemView) {
            ...
            TextView artists = ButterKnife.findById(itemView, R.id.collection_artist);

            TextView carnts = ButterKnife.findById(itemView, R.id.collection_carnt);
            ...
            carnts.setOnClickListener(this);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.title:
                    ...
                    break;
                case R.id.collection_artist:
                    // remove this line and do whatever you want to do for artists here
                    mContext.startActivity(new Intent(mContext, TheCollectionArtistActivity.class));

                    break;

                case R.id.collection_carnt:
                    // remove this line and do whatever you want to do for artists here
                    mContext.startActivity(new Intent(mContext, TheCollectionCarntActivity.class));
